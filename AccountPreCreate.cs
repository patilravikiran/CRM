        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    ...
                    // Read attriute values
                    string name = accountRecord.Attributes["name"].ToString();
                    //string name1 = accountRecord.GetAttributeValue<string>("name");
                    accountRecord.Attributes["name"] = name.ToUpper();
